...
/**
 * This class allows the tracker configuration from the subject perspective.
...
public class SubjectConfiguration implements Configuration {
    ...
    /**
     * The network UserID.
     * @apiNote It's not generated by the tracker, it needs to be filled by the developer on tracker instrumentation.
     */
    @NonNull
